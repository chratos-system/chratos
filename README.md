<hr />
<div align="center">
    <img src="images/logo-extended.png" alt="Logo" width='300px' height='auto'/>
</div>
<hr />
...
* Offers instantaneous transactions with zero fees and unlimited scalability, making Chratos an ideal solution for peer-to-peer transactions.
* As of May 2018, the Chratos network has processed over ten million transactions with an unpruned ledger size of only 3.8GB.
...
using Chratos. Let us know by [filing an issue](https://github.com/nanocurrency/raiblocks/issues), joining us in [reddit](https://reddit.com/r/nanocurrency), or joining us in [Discord](https://chat.nano.org/).
