...
public:
	...
	rai::node & node;
	bool on;
	static uint16_t const rpc_port = rai::rai_network == rai::rai_networks::rai_live_network ? 9126 : 45000;
};
...
public:
	...
	void key_expand ();
	void ledger ();
	void mrai_to_raw (rai::uint128_t = rai::Mchr_ratio);
	void mrai_from_raw (rai::uint128_t = rai::Mchr_ratio);
