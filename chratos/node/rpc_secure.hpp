...
{
/**
 * Specialization of chratos::rpc with TLS support
 */
class rpc_secure : public rpc
{
public:
	rpc_secure (boost::asio::io_service & service_a, chratos::node & node_a, chratos::rpc_config const & config_a);
...
/**
 * Specialization of chratos::rpc_connection for establishing TLS connections.
 * Handshakes with client certificates are supported.
 */
class rpc_connection_secure : public rpc_connection
{
public:
	rpc_connection_secure (chratos::node &, chratos::rpc_secure &);
