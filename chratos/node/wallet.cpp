...
std::shared_ptr<chratos::block> chratos::wallet::receive_action (chratos::block const & send_a, chratos::account const & representative_a, chratos::uint128_union const & amount_a, bool generate_work_a)
{
...
bool chratos::wallet::receive_sync (std::shared_ptr<chratos::block> block_a, chratos::account const & representative_a, chratos::uint128_t const & amount_a)
{
	std::promise<bool> result;
...
void chratos::wallet::receive_async (std::shared_ptr<chratos::block> block_a, chratos::account const & representative_a, chratos::uint128_t const & amount_a, std::function<void(std::shared_ptr<chratos::block>)> const & action_a, bool generate_work_a)
{
	...
	node.wallets.queue_wallet_action (amount_a, [this, block_a, representative_a, amount_a, action_a, generate_work_a]() {
		auto block (receive_action (*static_cast<chratos::block *> (block_a.get ()), representative_a, amount_a, generate_work_a));
		action_a (block);
	});
}
