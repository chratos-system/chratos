...
chratos::send_hashables::send_hashables (chratos::block_hash const & previous_a, chratos::account const & destination_a, chratos::amount const & balance_a) :
previous (previous_a),
...
chratos::send_block::send_block (chratos::block_hash const & previous_a, chratos::account const & destination_a, chratos::amount const & balance_a, chratos::raw_key const & prv_a, chratos::public_key const & pub_a, uint64_t work_a) :
...
chratos::open_hashables::open_hashables (chratos::block_hash const & source_a, chratos::account const & representative_a, chratos::account const & account_a) :
source (source_a),
...
chratos::open_block::open_block (chratos::block_hash const & source_a, chratos::account const & representative_a, chratos::account const & account_a, chratos::raw_key const & prv_a, chratos::public_key const & pub_a, uint64_t work_a) :
...
chratos::open_block::open_block (chratos::block_hash const & source_a, chratos::account const & representative_a, chratos::account const & account_a, std::nullptr_t) :
hashables (source_a, representative_a, account_a),
work (0)
{
	signature.clear ();
...
chratos::change_hashables::change_hashables (chratos::block_hash const & previous_a, chratos::account const & representative_a) :
previous (previous_a),
representative (representative_a)
{
}
...
chratos::change_block::change_block (chratos::block_hash const & previous_a, chratos::account const & representative_a, chratos::raw_key const & prv_a, chratos::public_key const & pub_a, uint64_t work_a) :
...
chratos::state_hashables::state_hashables (chratos::account const & account_a, chratos::block_hash const & previous_a, chratos::account const & representative_a, chratos::amount const & balance_a, chratos::uint256_union const & link_a) :
account (account_a),
previous (previous_a),
representative (representative_a),
balance (balance_a),
...
chratos::state_block::state_block (chratos::account const & account_a, chratos::block_hash const & previous_a, chratos::account const & representative_a, chratos::amount const & balance_a, chratos::uint256_union const & link_a, chratos::raw_key const & prv_a, chratos::public_key const & pub_a, uint64_t work_a) :
...
chratos::receive_block::receive_block (chratos::block_hash const & previous_a, chratos::block_hash const & source_a, chratos::raw_key const & prv_a, chratos::public_key const & pub_a, uint64_t work_a) :
...
chratos::receive_hashables::receive_hashables (chratos::block_hash const & previous_a, chratos::block_hash const & source_a) :
previous (previous_a),
source (source_a)
{
}
